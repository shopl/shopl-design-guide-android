package com.shopl.sdg.template.profile.mini
...
/**
 * SDG - Profile - Mini Profile
 *
 * avatar XXS(size 20)을 기준으로 1개의 정보만 표시하는 컴포넌트
 *
 * @param userRegImg 유저 이미지
 * @param activate 활성화 여부(활성화 여부에 따라 투명/반투명)
 *
 * @see <a href="https://www.figma.com/design/qWVshatQ9eqoIn4fdEZqWy/SDG?node-id=6840-15026&m=dev">Figma</a>
 */
@Composable
fun SDGMiniProfile(
    userRegImg: String?,
    ...
    type: SDGMiniProfileType = SDGMiniProfileType.NORMAL,
